...
> [!NOTE]
> Once this package is [published to npm](https://app.stainless.com/docs/guides/publish), this will become: `npx -y openregister-mcp`
...
```json
{
  "mcpServers": {
    "openregister_api": {
      "command": "node",
      "args": [
        "/path/to/local/openregister-typescript/packages/mcp-server",
        "--client=claude",
        "--tools=all"
      ],
      "env": {
