...
export { ClientOptions } from 'openregister';
...
async function getInstructions() {
  ...
  const response = await fetch(
    readEnv('CODE_MODE_INSTRUCTIONS_URL') ?? 'https://api.stainless.com/api/ai/instructions/openregister',
    {
      method: 'GET',
  ...
  if (!response.ok) {
    ...
    instructions = `
      This is the openregister MCP server. You will use Code Mode to help the user perform
